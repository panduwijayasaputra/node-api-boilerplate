...
var getUserByEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.user.count({ where: { email: email } })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var createUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.user.create({ data: user })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var editUserById = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.user.update({ where: { id: user.id }, data: user })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var deleteUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.user.delete({ where: { id: id } })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
